        ...
        <div className="macro-lab-panel">
          ...
          {payload?.globalMacro?.macroExplanation && (
            <div className="macro-lab-note" style={{ marginBottom: 8 }}>
              ...
              <br />
              <strong>Overlay interpretation:</strong> {payload.globalMacro.macroExplanation.overlayInterpretation.narrative}
              <details style={{ marginTop: 6 }}>
                <summary style={{ cursor: "pointer" }}>Visa block/overlay breakdown</summary>
                <div style={{ fontSize: 12, marginTop: 6 }}>
                  <strong>Core blocks</strong>
                  <ul>
                    {payload.globalMacro.macroExplanation.blockBreakdown.map((block) => (
                  ...
                  <ul>
                    {payload.globalMacro.macroExplanation.overlayBreakdown.map((overlay) => (
