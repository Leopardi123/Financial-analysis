                  ...
                  <div style={{ position: "relative", aspectRatio: "1 / 1", borderRadius: 8, background: "linear-gradient(135deg, #f8fafc 0%, #eef2ff 100%)", overflow: "hidden" }}>
                    ...
                    {prevPos && (
                      <div
                        ...
                        onClick={() => setPhaseSelectionNote(`Föregående position: ${phaseMomentum.label}.`)}
                      />
                    )}
                    {prevPos && movementDistance >= 0.01 && (
                      <svg viewBox="0 0 100 100" style={{ position: "absolute", inset: 0, width: "100%", height: "100%" }}>
                        ...
                        <line
                          ...
                          onClick={() => setPhaseSelectionNote(`Rörelse: ${phaseMomentum.label}.`)}
                        />
                      </svg>
                    )}
                    ...
                    <svg viewBox="0 0 100 100" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", filter: regimeProbabilityAny?.transitionLike ? "blur(3px)" : "blur(1px)" }}>
                      <path d={blobPath} fill="rgba(30,41,59,0.10)" opacity={Math.max(0.2, 1 - decisivenessNorm)} style={{ cursor: "pointer" }} onClick={() => setPhaseSelectionNote(`Osäkerhetsfält: ${(1 - decisivenessNorm).toFixed(2)} relativ osäkerhet med drag mot alternativregimer.`)} />
                    ...
                    <div
                      ...
                      onClick={() => setPhaseSelectionNote(`Nuvarande punkt: ${String(regimeProbabilityAny?.primaryRegime ?? "—")} (${safePct(regimeProbabilityAny?.primaryWeight)}).`)}
                    />
                  </div>
                    );
                  })()}
                </div>
                <div style={{ fontSize: 12, color: "#334155", marginBottom: 8 }}>{phaseSelectionNote}</div>
                              ...
                              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, marginBottom: 4 }}>
                                ...
                                <div style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                                  <button
                                    ...
                                    style={{ border: "1px solid #cbd5e1", borderRadius: 6, background: "#fff", cursor: "pointer", padding: "2px 8px", fontSize: 11 }}
                                    title="Resize chart"
                                  >
                                    &lt;—&gt;
                                  </button>
              ...
              {macroHistory && historyPoints.length > 0 ? (
                <>
                  ...
                  <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 6 }}>
                    <button type="button" onClick={() => setExpandedRegimeHistoryChart((prev) => !prev)} style={{ border: "1px solid #8e8678", borderRadius: 6, background: "#2f2b27", color: "#d6cfc4", cursor: "pointer", padding: "3px 9px", fontSize: 11 }}>&lt;—&gt;</button>
                  </div>
                  ...
                  <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 6 }}>
                    <button type="button" onClick={() => setExpandedBlockHistoryChart((prev) => !prev)} style={{ border: "1px solid #8e8678", borderRadius: 6, background: "#2f2b27", color: "#d6cfc4", cursor: "pointer", padding: "3px 9px", fontSize: 11 }}>&lt;—&gt;</button>
                  </div>
