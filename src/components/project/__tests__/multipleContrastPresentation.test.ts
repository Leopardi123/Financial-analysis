...
const qualityRow = (overrides: Partial<CorporateQualityMultipleRow> = {}): CorporateQualityMultipleRow => ({
  ...
  durationContextFactor: 1, originalStabilityAdjustment: 0.5, durationAdjustedStabilityAdjustment: 0.5,
  originalSustainingAdjustment: 0.25, durationAdjustedSustainingAdjustment: 0.25,
  originalMarginAdjustment: 0.5, durationAdjustedMarginAdjustment: 0.5,
