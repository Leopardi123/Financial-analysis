...
export const CASINO_RUNTIME_CONSTRUCTION_START_YEAR = 2031;
export const CASINO_RUNTIME_PRODUCTION_START_YEAR = 2033;
export const CASINO_RUNTIME_NAMEPLATE_YEAR = 2036;
