...
export const GRASSY_MOUNTAIN_SUMMARY_PAYABLE_AG_OZ = 477_700;
export const GRASSY_MOUNTAIN_ANNUAL_PAYABLE_AG_OZ = 477_800;
export const GRASSY_MOUNTAIN_SUMMARY_RECOVERED_AG_OZ = 480_100;
export const GRASSY_MOUNTAIN_ANNUAL_RECOVERED_AG_OZ = 480_000;
