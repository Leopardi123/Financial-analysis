...
export const US_FRED_SERIES: FredSeriesConfig[] = [
  ...
  { fredSeriesId: "WALCL", seriesKey: "WALCL" },
  { fredSeriesId: "WDTGAL", seriesKey: "WDTGAL" },
  { fredSeriesId: "RRPONTSYD", seriesKey: "RRPONTSYD" },
  { fredSeriesId: "TOTBKCR", seriesKey: "TOTBKCR" },
  { fredSeriesId: "GDP", seriesKey: "GDP", latestLookbackMonths: 240, backfillLookbackYears: 25 },
