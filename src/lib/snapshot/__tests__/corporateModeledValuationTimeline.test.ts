  ...
  const timeline = buildCorporateModeledValuationTimeline({
    ...
    lista2MetricsByTp: {
      4: {
        ...
        NPV_prodStart_TargetCurrency: -3.934778424225897,
        NPV_prodStart_perShare_TargetCurrency: -0.03934778424225897,
        InitialCAPEX_incremental_TargetCurrency: 350,
      },
    },
  ...
  const timeline = buildCorporateModeledValuationTimeline({
    ...
    lista2MetricsByTp: {
      4: {
        ...
        NPV_prodStart_TargetCurrency: 40,
        NPV_prodStart_perShare_TargetCurrency: 0.4,
        InitialCAPEX_incremental_TargetCurrency: 110,
      },
    },
  });
  ...
  const timeline = buildCorporateModeledValuationTimeline({
    ...
    lista2MetricsByTp: {
      2: {
        ...
        NPV_prodStart_TargetCurrency: 0,
        NPV_prodStart_perShare_TargetCurrency: 0,
        InitialCAPEX_incremental_TargetCurrency: 0,
      },
    },
  });
  ...
  const timeline = buildCorporateModeledValuationTimeline({
    ...
    lista2MetricsByTp: {
      1: {
        ...
        NPV_prodStart_TargetCurrency: 10,
        NPV_prodStart_perShare_TargetCurrency: null,
        InitialCAPEX_incremental_TargetCurrency: 10,
      },
    },
  });
